...
class NamespaceImportImplementation(
    ...
    elementId = elementId, ownedElements = mutableListOf(), owner = owner,
    ...
    override fun toString(): String = "Import { $importedNamespace }"

    override fun clone() = NamespaceImportImplementation(
