...
import com.github.tukcps.sysmd.Init
...
import com.github.tukcps.sysmd.entities.ValueFeature
import com.github.tukcps.sysmd.entities.implementation.AnnotatingElementImplementation
...
fun AgilaSession.loadSysMD(
    ...
    ParserSysMD(this, create(rep, global)).parseSysMD()
...
fun TextualRepresentation.compile() {
    ParserSysMD(model!!, this).parseSysMD()
}
...
fun ValueFeature.parseDependency() {
    ...
    try {
        if (model != null) {
            val parserSysMD = ParserSysMD(model!!, TextualRepresentationImplementation(language = "SysMD", body = dependency), dependency)
